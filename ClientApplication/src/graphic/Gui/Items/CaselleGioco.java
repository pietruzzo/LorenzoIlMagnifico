...
public class CaselleGioco {
    ...
    private static final Point2D[] COORDINATE_CASELLE = {new Point2D(0, 0), //casella 0 non usata
            ...
            new Point2D(342, 585), //casella 9 (TorrePersonaggio)
            new Point2D(342, 436), //casella 10(TorrePersonaggio)
            new Point2D(342, 284), //casella 11(TorrePersonaggio)
            new Point2D(342, 132), //casella 12(TorrePersonaggio)
